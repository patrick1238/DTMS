 ...
 * @author rehkind
 */
public class CaseFloatMetadataFilterPane extends FilterPane{
    
    CaseServiceMetadataFloatFilter filter;
    ...
    public CaseFloatMetadataFilterPane(String metadataFieldName){ this(metadataFieldName, null); }
    
    public CaseFloatMetadataFilterPane(String metadataFieldName, String serviceType){
        this(metadataFieldName, serviceType, CaseServiceMetadataFloatFilter.MODE_MIN);
    }
    
    public CaseFloatMetadataFilterPane(String metadataFieldName, String serviceType, Integer filterMode){
        super();
        filter = new CaseServiceMetadataFloatFilter(metadataFieldName,"",filterMode,new Double[]{null,null,null});
    ...
    public Double castValue(String strValue){
        Double castedValue = null;
        if(strValue==""){ return null; }
        try{
            castedValue = Double.valueOf(strValue);
    ...
    private void updateGui(){
        switch(filter.getSearchMode()){
            case CaseServiceMetadataFloatFilter.MODE_MIN:
                ...
                break;
            case CaseServiceMetadataFloatFilter.MODE_MAX:
                lblEqualField.setOpacity(0.5);
                txtEqualField.setDisable(true);
                ...
                break;
            case CaseServiceMetadataFloatFilter.MODE_MIN_MAX:
                lblEqualField.setOpacity(0.5);
                txtEqualField.setDisable(true);
                lblMinField.setOpacity(1);
                txtMinField.setDisable(false);
                ...
                txtMaxField.setDisable(false);
                break;
            case CaseServiceMetadataFloatFilter.MODE_EQUALS:
