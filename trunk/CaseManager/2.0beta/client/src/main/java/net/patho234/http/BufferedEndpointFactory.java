...
import net.patho234.utils.JsonObjectHttpResponse;
import net.patho234.utils.RegisteredHttpAccessRequest;
import net.patho234.utils.ServerSettings;
import net.patho234.http.IBufferedEndpoint;
...
public class BufferedEndpointFactory {
    ...
    static IBufferedEndpoint getBufferedEndpoint(String endpoint, ServerSettings serverSettings){
        switch( endpoint ){
            ...
            case HTTP_ENDPOINT_TEMPLATES.GET_SUBMITTER:
            case HTTP_ENDPOINT_TEMPLATES.GET_SUBMITTERS:
            case HTTP_ENDPOINT_TEMPLATES.CREATE_SUBMITTER:
            if(endpoints.get("SUBMITTERS:"+serverSettings.serverAddress)==null){
