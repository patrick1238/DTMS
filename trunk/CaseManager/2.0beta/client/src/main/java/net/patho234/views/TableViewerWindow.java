...
public class TableViewerWindow extends Stage {
    ...
    private void preloadClientObjectPools(StatusWindowController wndControl) throws IOException{
        ...
        Platform.runLater(new TableViewerWindow.StatusUpdate(wndControl, "Loading clinics...", 5));
        ...
        Platform.runLater(new TableViewerWindow.StatusUpdate(wndControl, "Loading service definitions...", 24));
        ...
        Platform.runLater(new TableViewerWindow.StatusUpdate(wndControl, "Loading services...", 56));
        ...
        Platform.runLater(new TableViewerWindow.StatusUpdate(wndControl, "Loading cases...", 69));
        ...
        Platform.runLater(new TableViewerWindow.StatusUpdate(wndControl, "Launching...", 100));
        
        Platform.runLater(new TableViewerWindow.StatusUpdate(wndControl, "Terminate status", -1));
    }
