...
CMD="cp ${SRC_DIRECTORY}/webapp_server_lib/target/webapp_server_lib-0.1.jar ./modules/net/rehkind_mag/webapplib/main/"
#echo "CMD=$CMD"
$CMD
### WEBSERVER
echo "	copying patho server application: webapp_server-ejb-0.1.jar"
...
CMD="cp ${SRC_DIRECTORY}/webapp_server-web/target/webapp_server-web-0.1.war ./standalone/deployments/"
#echo "CMD=$CMD"
$CMD