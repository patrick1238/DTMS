 ...
 */
@Embeddable
public class MetadataIntEntityPK implements Serializable {
    ...
    public MetadataIntEntityPK() {
    }

    public MetadataIntEntityPK(int fkeyService, String key) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof MetadataIntEntityPK)) {
            return false;
        }
        MetadataIntEntityPK other = (MetadataIntEntityPK) object;
    ...
    public String toString() {
        return "net.rehkind_mag.entity.MetadataIntEntityPK[ fkeyService=" + fkeyService + ", key=" + metaKey + " ]";
    }
