...
public class Case {
    ...
    public void add_block(Integer block_id) {
        ...
        for (String stain : stains.get_Stains(this.Diagnosis.get())) {
            current_block.add(new Slice(stain, "pending", block_id, this));
        }
        this.biopsy_material.put(block_id, FXCollections.observableArrayList(current_block));
    }

    public void remove_block(Integer block_id) {
    ...
    public void add_slice(String stain, Integer block_id) {
        if (this.biopsy_material.containsKey(block_id)) {
            this.biopsy_material.get(block_id).add(new Slice(stain, "pending", block_id, this));
        }
