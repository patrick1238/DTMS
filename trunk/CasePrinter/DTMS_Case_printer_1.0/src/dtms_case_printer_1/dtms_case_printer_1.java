 ...
 * @author patri
 */
public class dtms_case_printer_1 extends Application{
    ...
    public void start_splashscreen(Stage stage) {
        ...
        try {
            ...
            Logger.getLogger(dtms_case_printer_1.class.getName()).log(Level.SEVERE, null, ex);
        }
