 ...
 */
package dtms_case_printer_1_beta;
 ...
 * @author patri
 */
public class dtms_case_printer_1_beta extends Application{
    ...
    public void start_splashscreen(Stage stage) {
        ...
        try {
            ...
            Logger.getLogger(dtms_case_printer_1_beta.class.getName()).log(Level.SEVERE, null, ex);
        }
