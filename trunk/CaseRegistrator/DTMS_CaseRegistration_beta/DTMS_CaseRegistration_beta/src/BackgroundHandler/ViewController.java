...
public class ViewController {
    ...
    RegisterScreenController maincontroller;
    TableWindowController controller;

    private ViewController(RegisterScreenController maincontroller) {
    ...
    public static void initializeViewController(RegisterScreenController maincontroller){
    ...
    public RegisterScreenController getMainWindowController(){
